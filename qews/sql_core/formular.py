...
class Formular():
    ...
    def Create(sqlite3_connection):
        ...
        # sqlite3_connection.create_function("Formular_add_days", 2, Formular.fomular_add_days)
        ...
        # sqlite3_connection.create_function("Fomular_dateadd", 1, Formular.fomular_dateadd)
        # sqlite3_connection.create_function("Fomular_datediff", 3, Formular.fomular_datediff)
        # sqlite3_connection.create_function("Fomular_dayofmonth", 1, Formular.fomular_dayofmonth)
    ...
    # @staticmethod   
    # def fomular_add_days(date, number_date):
    #     try:
    #         ser = pd.Series([date])
    #         ser = pd.to_datetime(ser)

    #         ser = ser + timedelta(days=3)
    #         print (ser.values)
